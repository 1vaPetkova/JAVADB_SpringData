...
import com.example.java_db_09_exercise_car_dealer_db.model.dto.view.Q06.CarSaleDto;
import com.example.java_db_09_exercise_car_dealer_db.model.dto.view.Q06.SaleCarCustomerDto;
...
public class SaleServiceImpl implements SaleService {
    ...
    //Q06
    @Override
    public SaleCarCustomerRootDto findALlSalesWithCustomersAndPrice() {
        SaleCarCustomerRootDto saleCarCustomerRootDto = new SaleCarCustomerRootDto();
        saleCarCustomerRootDto.setSales(this.saleRepository
                .findAll()
                .stream()
                .map(sale -> {
    ...
    private Double findRandomDiscount() {
        ...
        return Math.round(discounts.get(randomIndex))/100.0;
    }
}
